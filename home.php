...
<!--
		<div class="we-branding">
			<div class="wesite-title">
				<a href="<?php $this->options ->siteUrl(); ?>" ><img src="<?php echo theurl; ?>images/akina1.png"></a>
			</div>
...
-->
	...
	<ul class="we-content">
		<li class="we-menu1">
			<a href="<?php $this->options ->siteUrl(); ?>index.php"><span class="we-home we-icon"></span>
...
<div class="we-footer">
	<div class="we-info">Copyright © 2019 by <a href="<?php $this->options ->siteUrl(); ?>" target="_blank" rel="nofollow"><?php $this->options->title() ?></a> . All rights reserved.	<span class="sep"> | </span>Theme: <a href="https://aqours.life" target="_blank" rel="nofollow" rel="designer">Aqours For Typecho</a>.
